...
# ✅ Update the path below to where your file is actually stored
...
# --- 2D Histogram (salary vs salary_in_usd) ---
plt.figure(figsize=(6,4))
sns.histplot(
...
# =============================
# 🎨 ggplot2 Style Visualization using plotnine
# =============================
